...
public class AbstractSessionToTrackLoggerCsvExporterTest {
    ...
    public void testExport() throws Exception {
        ...
        assertEquals(
                "running_time,synch_timestamp,accel_capture_timestamp,longitudinal_accel,lateral_accel,vertical_accel,location_capture_timestamp,latitude,longitude,altitude,speed,bearing,ecu_capture_timestamp,rpm,map,mgp,throttle_position,afr,mat,clt,ignition_advance,battery_voltage,lap_capture_timestamp,lap,split",
                lines.get(5));
        assertEquals(
    ...
    private final class AbstractSessionToTrackLoggerCsvExporterHarness extends AbstractSessionToTrackLoggerCsvExporter {
        ...
        public AbstractSessionToTrackLoggerCsvExporterHarness(File exportDir) {
            super(exportDir, new NoOpNotificationListener<SessionExporterNotificationType>());
        }
        ...
        protected void exportEntries(Writer writer, int sessionId,
            ...
            writeEntry(writer, 1l, 2l, 3f, 4f, 5f, 6l, 7d, 8d, 9d, 10f, 11f, 12l, 13, 14d, 24d, 15d, 16d, 17d, 18d, 19d, 20d, 21l, 22, 23);
            writeEntry(writer, TimeUtil.MS_IN_DAY - 1, 12l, 13f, 14f, 15f, 16l, 17d, 18d, 19d, 110f, 111f, 112l, 113, 114d, 124d, 115d, 116d, 117d, 118d, 119d, 120d, 121l, 122, 123);
            writeEntry(writer, 1, 12l, 13f, 14f, 15f, 16l, 17d, 18d, 19d, 110f, 111f, 112l, 113, 114d, 124d, 115d, 116d, 117d, 118d, 119d, 120d, 121l, 122, 123);
        }
